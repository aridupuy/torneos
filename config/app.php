<?php
if(!defined("GENERAR_ID_MAXIMO")){
    define('GENERAR_ID_MAXIMO', getenv("GENERAR_ID_MAXIMO"));
    ...
    define('DATABASE_USERPASS', getenv("DB_PASSWORD"));
...
include_once __DIR__.'/../app/libs/lib.php';
App\Models\Model::singleton();
return [
    ...
    */
    ...
    'url' => env('APP_URL', 'http://localhost:126'),
